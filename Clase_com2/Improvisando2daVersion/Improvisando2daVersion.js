...
function DibujarCirculos(posX, posY, diametro, numCirculos) {
  for (let i=0; i < numCirculos; i++) {
    ...
    let posYInteraccion = map(nuevoDiametro, diametro, diametro/numCirculos, posY, mouseY);
    circle(constrain(posXInteraccion, posX - diametro/numCirculos, posX+diametro/numCirculos), constrain(posYInteraccion, posY - diametro/numCirculos, posY+diametro/numCirculos), nuevoDiametro);
  }
}
